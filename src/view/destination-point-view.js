...
function createDestinationPointTemplate(point) {
  ...
  const favoriteButtonTemplate = `<button class="event__favorite-btn ${isFavorite ? 'event__favorite-btn--active' : ''}" type="button">
  ...
  return `<li class="trip-events__item">
              <div class="event">
                ...
                <div class="event__schedule">
                  <p class="event__time">
                    <time class="event__start-time" datetime="${dateFrom}">${startTimeOnly}</time>
                    &mdash;
